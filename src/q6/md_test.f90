...
!!------------------------------------------------------------------------------
    ...
    do i=1,nat_solute
      ...
      write(*,*), "At_ID", i, "Vel", v(i3+2)
      write(*,*), "At_ID", i, "Vel", v(i3+3)
    ...
    write(*,*), Tfree_solute, Texcl_solute, Temp_solute
    ...
    write(*,*) "Tscale_solute, Temp, Tfree, Ndegf, Ndegfree"
    write(*,*) Tscale_solute, Temp, Tfree, Ndegf, Ndegfree
...
subroutine nonbond_3atomsolvent
  ...
  do iw = calculation_assignment%ww%start, calculation_assignment%ww%end
    ...
    do while (nbww(ip) /= 0)
      ...
      E%ww%vdw = E%ww%vdw + evdw
      E%ww%el = E%ww%el + ecoul
    end do ! while ip
